/** Default tab title for the site and the home route after the welcome animation. */
...
/** After the full welcome string is shown, wait this long before restoring {@link SITE_TITLE}. */
export const HOME_WELCOME_HOLD_MS = 2000;
